...
export const logout = params => request.get('/fe/api_proxy/user/loginout/', params);
...
export const get_device_info = params => request.get('/api/api_proxy/device/info/', params)
export const enumList = params => request.get('/api/api_proxy/enum/list/' + params + '/')
export const list_events_v2 = params => request.get('/api/api_proxy/event/list_events_v3/', params)
